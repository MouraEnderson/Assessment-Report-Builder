...
const serviceVersion = process.env.SERVICE_VERSION || '0.2.1';
...
app.get('/', sendFrontendFile('index.html', 'html'));
app.get('/index.html', sendFrontendFile('index.html', 'html'));
app.get('/styles.css', sendFrontendFile('styles.css', 'css'));
app.get('/config.js', sendFrontendFile('config.js', 'application/javascript'));
app.get('/assessment-state.js', sendFrontendFile('assessment-state.js', 'application/javascript'));
app.get('/assessment-api-client.js', sendFrontendFile('assessment-api-client.js', 'application/javascript'));
app.get('/assessment-controller.js', sendFrontendFile('assessment-controller.js', 'application/javascript'));
app.get('/app.js', sendFrontendFile('app.js', 'application/javascript'));
...
app.listen(port, '0.0.0.0', () => {
  console.log(`Assessment Report Builder v${serviceVersion} running on port ${port}`);
});
